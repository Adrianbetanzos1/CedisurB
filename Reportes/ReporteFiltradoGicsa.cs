...
{
    public partial class ReporteFiltradoGicsa : Form
    {
        private readonly DataTable datosInforme;
        public ReporteFiltradoGicsa(DataTable datosInforme)
        {
            InitializeComponent();
            this.datosInforme = datosInforme;
        }

        private void ReporteFiltradoGicsa_Load(object sender, EventArgs e)
        {
            reportViewer1.LocalReport.ReportEmbeddedResource = "CedisurB.Reportes.Report12.rdlc";
