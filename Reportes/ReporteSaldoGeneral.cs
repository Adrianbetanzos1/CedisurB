...
{
    public partial class ReporteSaldoGeneral : Form
    {
        private readonly DataTable datosInforme;
        public new Form ParentForm;
        public ReporteSaldoGeneral(DataTable datosInforme)
        {
            InitializeComponent();
            this.datosInforme = datosInforme;
        }

        private void ReporteSaldoGeneral_Load(object sender, EventArgs e)
        {
            reportViewer1.LocalReport.ReportEmbeddedResource = "CedisurB.Reportes.Report3.rdlc";
