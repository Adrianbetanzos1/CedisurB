...
{
    public partial class ReporteSaldosGicsa : Form
    {
        private readonly DataTable datosInforme;
        public new Form ParentForm;
        public ReporteSaldosGicsa(DataTable datosInforme)
        {
            InitializeComponent();
            this.datosInforme = datosInforme;
        }

        private void ReporteSaldosGicsa_Load(object sender, EventArgs e)
        {
            reportViewer1.LocalReport.ReportEmbeddedResource = "CedisurB.Reportes.Report10.rdlc";
